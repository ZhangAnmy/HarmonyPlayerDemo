...
public class PlayAbilitySlice extends AbilitySlice {
    // Define log label
    private static final HiLogLabel TAG = new HiLogLabel(HiLog.LOG_APP, 0x00201, "PlayAbilitySlice");
    ...
    private void controlMusicStatus(){
        ...
        if(currentStatus != null && currentStatus.equals("pause")){ //Pause the radio
            ...
            intent.setElement(new ElementName("","com.huawei.radiolinedemo", ".PlayServiceAbility"));
    ...
    private void startPlayMusic(){
        ...
        //intent.setElement(new ElementName("","com.huawei.radiolinedemo", "com.huawei.radiolinedemo.IjkAudioPlayerServiceAbility"));
        startAbility(intent);
